...
(def-doom-theme paledeep
  ...
  (((lazy-highlight &override) :background base4 :foreground fg :distant-foreground fg :bold bold)
   ...
   (org-meta-line                    :foreground base4                   :height 1.1)
   (org-document-info-keyword                                            :height 1.2 :foreground yellow  :inherit 'bold)
   (org-document-info                                                    :height 1.5 :foreground magenta :inherit 'bold)
