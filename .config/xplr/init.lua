...
------ Logs
-------- Error
xplr.config.general.logs.error = {
    style = {
        add_modifiers = nil,
        sub_modifiers = nil,
        bg = nil,
...
-------- Success
xplr.config.general.logs.success = {
    style = {
        bg = nil,
        fg = { Rgb = { 152, 190, 101 } },
        add_modifiers = nil,
...
-------- Warning
xplr.config.general.logs.warning = {
    style = {
        add_modifiers = nil,
        bg = nil,
        fg = { Rgb = { 247, 140, 108 } },
...
xplr.config.general.focus_ui = {
    style = {
        ...
        fg = { Rgb = { 236, 190, 123 } },
        add_modifiers = nil,
        sub_modifiers = { "Bold", "Italic", "Dim",
                          "Underlined", "SlowBlink", "RapidBlink",
                          "Reversed", "CrossedOut" },
    },
    prefix = " [",
    suffix = "]",
...
------ Selection UI
xplr.config.general.selection_ui = {
    style = {
        bg = { Rgb = { 30, 28, 49 } },
        fg = nil,
        add_modifiers = nil,
...
------ Sort & filter UI
-------- Separator
xplr.config.general.sort_and_filter_ui.separator = {
    style = {
        bg = nil,
        fg = { Rgb = { 206, 206, 206 } },
        add_modifiers = nil,
...
xplr.config.general.sort_and_filter_ui.sort_direction_identifiers = {
    forward = {
        style = {
            bg = nil,
            fg = { Rgb = { 255, 85, 112 } },
...
xplr.config.general.table.header.style.add_modifiers = { "Bold", "Italic" }
